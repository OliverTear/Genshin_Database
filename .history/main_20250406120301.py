        ...
        return ft.View(
            ...
            appbar=ft.AppBar(
                ...
                actions=[
                    ...
                    ft.IconButton(ft.Icons.HOURGLASS_FULL_OUTLINED, on_click=lambda _: navigate_to("add_artifact")),
                    ft.IconButton(ft.Icons.swords, on_click=lambda _: navigate_to("add_weapon")),
