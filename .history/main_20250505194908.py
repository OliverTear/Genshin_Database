        ...
        def search(e):
            ...
            if kind == None and rarity == None and searchbar.value == "":
                ...
                if weaponresult == []:
                    ...
                    header = [ft.DataColumn(ft.Text("武器種")), ft.DataColumn(ft.Text("星")), ft.DataColumn(ft.Text("名前")), ft.DataColumn(ft.Text("基礎攻撃力")),ft.DataColumn(ft.Text("サブ効果")),ft.DataColumn(ft.Text("サブ効果値")), ft.DataColumn(ft.Text("決定"))]
