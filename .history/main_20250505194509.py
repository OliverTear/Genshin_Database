            ...
            if kind == None and rarity == None and searchbar.value == "":
                ...
                if weaponresult == []:
                    ...
                    for data in weaponresult:
                        ...
                        cells = [ft.DataCell(ft.Text(data[0])),ft.DataCell(ft.Text(data[1])),ft.DataCell(ft.Text(data[2])),ft.DataCell(ft.Text(data[3])), ft.DataCell(checkbutton)]
                        rows.append(ft.DataRow(cells=cells))
                    header = [ft.DataColumn(ft.Text("武器種")), ft.DataColumn(ft.Text("レアリティ")), ft.DataColumn(ft.Text("名前")), ft.DataColumn(ft.Text("基礎攻撃力")), ft.DataColumn(ft.Text("決定"))]
