...
cur.execute('CREATE TABLE IF NOT EXISTS WeaponList(type STRING, rarity INT, name STRING, BASEATK INT, SubEffect STRING, SubEffectValue STRING, Support BOOL, Get STRING)')
